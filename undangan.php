...
$database = "wedding_db"; // Sesuaikan dengan nama database
...
$query = "SELECT * FROM undangan ORDER BY id DESC LIMIT 1";
$result = mysqli_query($conn, $query);
$data = mysqli_fetch_assoc($result);

// Jika data tidak ditemukan, beri nilai default
$nama_panggilan_pria = $data['nama_panggilan_pria'] ?? "Sandhika";
$nama_panggilan_wanita = $data['nama_panggilan_wanita'] ?? "Nofariza";
$tanggal_pernikahan = $data['tanggal_pernikahan'] ?? "20 November 2023";
$tempat_pernikahan = $data['tempat_pernikahan'] ?? "Gedung Kologdam, Bandung";
?>
...
<body>
  ...
  <section id="hero"
    ...
    <main>
      ...
      <h1><?php echo htmlspecialchars($nama_panggilan_pria) . " & " . htmlspecialchars($nama_panggilan_wanita); ?></h1>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          ...
          <h3>Diselenggarakan pada <?php echo htmlspecialchars($tanggal_pernikahan); ?> di <?php echo htmlspecialchars($tempat_pernikahan); ?>.</h3>
      ...
      <div class="row couple">
        <div class="col-lg-6">
          <div class="row">
            ...
            <h3><?php echo htmlspecialchars($data['nama_lengkap_pria'] ?? "Nama Pria"); ?></h3>
        ...
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-8">
            <h3><?php echo htmlspecialchars($data['nama_lengkap_wanita'] ?? "Nama Wanita"); ?></h3>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque praesentium aut ipsa perferendis,
                incidunt soluta?</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col text-center">
          <small class="block">&copy; 2025 Invitely. All Rights Reserved.</small>
